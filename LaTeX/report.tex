...
Se recibirá como entrada un archivo con los enlaces semilla para empezar a inspeccionar los URL, además de un URL de domino base para filtrar la inspección de URLs, un entero máximo de URLs a visitar, y una lista de descargadores a los cuales conectarse.
...
El script recibe por parámetro un número entero que indica la cantidad de descargadores que quieren iniciarse, y el nombre de cada uno con sus respectivas bases de datos son almacenados en archivos, de tal manera que el cliente pueda accederlas fácilmente.
...
El cliente leerá los descargadores disponibles del archivo generado por el script anterior.
